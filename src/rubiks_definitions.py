...
CORNER_FACELETS = [
    ...
    [Fac.U_6_corner, Fac.F_0_corner, Fac.L_corner1],
    [Fac.U_0_corner, Fac.L_corner0, Fac.B_corner1],
    [Fac.U_2_corner, Fac.B_corner0, Fac.R_2_corner],
    [Fac.D_corner1, Fac.F_8_corner, Fac.R_6_corner],
    [Fac.D_corner0, Fac.L_corner3, Fac.F_6_corner],
